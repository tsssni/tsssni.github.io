...
\begin{aligned}
W_s^r
&= W_s J_s \frac{\sum_{i=0}^{N - 1} \frac{M_i'}{M_i} w_i^\sigma J_i}{\frac{M_s'}{M_s} w_s^\sigma J_s}\frac{M_s'}{\sum_{i=0}^{N - 1}M_i'}\\
&= \frac{w_s^\sigma}{\hat{p}_i(X_s)M_s} J_s \frac{\sum_{i=0}^{N - 1} \frac{M_i'}{M_i} w_i^\sigma J_i}{\frac{M_s'}{M_s} w_s^\sigma J_s}\frac{M_s'}{\sum_{i=0}^{N - 1}M_i'}\\
&= \frac{\sum_{i=0}^{N - 1} \frac{M_i^s}{M_s} w_i^\sigma J_i}{\hat{p}_i(X_s) \sum_{i=0}^{N - 1}M_i'}
\end{aligned}
\end{equation}
$$
